...
public:
    ...
    void setupUi(QDialog *optionssauvepoints)
    {
        ...
        optionssauvepoints->setWindowModality(Qt::NonModal);
        optionssauvepoints->resize(500, 330);
        optionssauvepoints->setModal(false);
        ...
        NummeasBox->setGeometry(QRect(160, 170, 62, 41));
        NummeasBox->setFocusPolicy(Qt::StrongFocus);
        ...
        lineEdit->setGeometry(QRect(120, 20, 270, 40));
        QFont font;
...
""));
        ...
        CancelButton->setGeometry(QRect(30, 280, 201, 41));
...
"background-color: rgb(230, 230, 230);"));
        ...
        SaveButton->setGeometry(QRect(280, 280, 191, 41));
